...
<div id="header">
    ...
    <ul class="my">
        <li><a href="#"><i class="iconfont">&#260;</i>关注我</a>
            <ul>
                <li><a href="<?php bloginfo('rss2_url'); ?>" rel="external nofollow" target="_blank"><i class="iconfont">&#483;</i>RSS订阅</a>
                    <ul>
                    <li><a href="<?php bloginfo('rss2_url'); ?>" rel="external nofollow" target="_blank">RSS Feed</a></li>
                    <li><a href="http://mail.qq.com/cgi-bin/feed?u=<?php bloginfo('rss2_url'); ?>" rel="external nofollow" target="_blank">订阅到 QQ邮箱</a></li>
                    <li><a href="http://reader.youdao.com/b.do?keyfrom=bookmarklet&url=<?php bloginfo('rss2_url'); ?>" rel="external nofollow" target="_blank">订阅到 有道阅读</a></li>
                    <li><a href="http://xianguo.com/subscribe?url=<?php bloginfo('rss2_url'); ?>" rel="external nofollow" target="_blank">订阅到 鲜果</a></li>
                    <li><a href="http://www.zhuaxia.com/add_channel.php?sourceid=102&url=<?php bloginfo('rss2_url'); ?>" rel="external nofollow" target="_blank">订阅到 抓虾</a></li>
                    <li><a href="http://www.google.com/ig/add?feedurl=<?php bloginfo('rss2_url'); ?>" rel="external nofollow" target="_blank">订阅到 iGoogle</a></li>
                    </ul>
                </li>
